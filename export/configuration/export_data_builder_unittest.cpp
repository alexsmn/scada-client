...
const scada::NodeId kPropDeclId = data_items::id::DataItemType_Alias;
...
scada::NodeState MakeNodeState(const scada::NodeId& node_id,
  ...
  return {.node_id = node_id,
          ...
          .properties = {{kPropDeclId, node_id.ToString()}}};
}
...
TEST(ExportDataBuilder, Test) {
  ...
  EXPECT_THAT(export_data.nodes,
              UnorderedElementsAre(
                  FieldsAre(
                      ...
                      /*display_name=*/u"ТИТ 11",
                      /*property_values=*/
                      Contains(Field(&ExportData::PropertyValue::node_id,
                                     kPropDeclId))),
                  FieldsAre(
  ...
  EXPECT_THAT(export_data.props,
              Contains(FieldsAre(
                  /*node_id=*/data_items::id::DiscreteItemType_Inversion,
