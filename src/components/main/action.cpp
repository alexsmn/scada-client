...
ActionManager::ActionManager(NodeService& node_service) {
  ...
  AddAction(*new Action(ID_OPEN_GRAPH, CATEGORY_OPEN, L"График",
                        base::string16(), ID_GRAPH_VIEW,
                        Action::ALWAYS_VISIBLE));
  AddAction(*new Action(ID_TIMED_DATA_VIEW, CATEGORY_OPEN, L"Данные",
                        base::string16(), IDB_TIMED_DATA,
                        Action::ALWAYS_VISIBLE));
  AddAction(*new Action(ID_OPEN_DISPLAY, CATEGORY_OPEN, L"Схема",
                        base::string16(), ID_MODUS_VIEW,
                        Action::ALWAYS_VISIBLE));
  AddAction(*new Action(ID_OPEN_TABLE, CATEGORY_OPEN, L"Таблица",
                        base::string16(), ID_TABLE_VIEW,
                        Action::ALWAYS_VISIBLE));
  AddAction(*new Action(ID_OPEN_SUMMARY, CATEGORY_OPEN, L"Сводка",
                        base::string16(), IDB_SUMMARY, Action::ALWAYS_VISIBLE));
  AddAction(*new Action(ID_HISTORICAL_EVENTS, CATEGORY_OPEN, L"События",
                        base::string16(), IDB_OPEN_EVENTS,
                        Action::ALWAYS_VISIBLE));

  AddAction(*new Action(ID_OPEN_GROUP_TABLE, CATEGORY_OPEN, L"Таблица группы",
                        base::string16(), 0, Action::VISIBLE));

  AddAction(*new Action(ID_ACKNOWLEDGE_CURRENT, CATEGORY_ITEM, L"Квитировать"));
  AddAction(*new Action(ID_UNLOCK_ITEM, CATEGORY_ITEM, L"Снять блокировку",
                        base::string16(), IDB_UNLOCK));
  AddAction(*new Action(ID_WRITE, CATEGORY_ITEM, L"Управление...",
                        L"Управление", IDB_WRITE));
  AddAction(*new Action(ID_WRITE_MANUAL, CATEGORY_ITEM, L"Ручной ввод...",
                        L"Ручной ввод", IDB_WRITE_MANUAL));
  AddAction(
  ...
  AddAction(*new Action(ID_PRINT, CATEGORY_SETUP, L"Печать", base::string16(),
                        IDB_PRINTER));
  ...
  AddAction(*new Action(ID_ACKNOWLEDGE_ALL, CATEGORY_VIEW, L"Квитировать все",
                        base::string16(), IDB_ACKNOWLEDGE_ALL));
  AddAction(*new Action(ID_SEVERITY_CUSTOM, CATEGORY_VIEW, L"Важность...",
                        L"Важность"));
  AddAction(
  ...
  AddAction(*new Action(ID_EVENT_VIEW, CATEGORY_VIEW, L"Панель событий",
                        base::string16(), ID_EVENT_VIEW));
  AddAction(*new Action(ID_SAVE, CATEGORY_VIEW, L"Сохранить"));
  AddAction(*new Action(ID_SAVE_AS, CATEGORY_VIEW, L"Сохранить как...",
                        L"Сохранить"));
  ...
  AddAction(*new Action(ID_TIME_RANGE_CUSTOM, CATEGORY_PERIOD, L"Другой...",
                        L"Другой"));

  AddAction(*new Action(ID_ITEM_PARAMS, CATEGORY_EDIT, L"Параметры",
                        base::string16(), IDB_RECORD_EDITOR));
  AddAction(*new Action(ID_TABLE_CONFIG, CATEGORY_EDIT, L"Параметры элементов",
                        L"Элементы"));
  AddAction(*new Action(ID_TRANSMISSION_VIEW, CATEGORY_EDIT,
                        L"Таблица ретрансляции", L"Ретрансляция"));
  AddAction(*new Action(ID_NEW_PORTFOLIO, CATEGORY_EDIT, L"Создать портфолио"));
  AddAction(*new Action(ID_ADD_ITEMS, CATEGORY_EDIT, L"Добавить объекты...",
                        L"Добавить объекты"));
  AddAction(*new Action(ID_RENAME, CATEGORY_EDIT, L"Переименовать"));
  AddAction(*new Action(ID_DELETE, CATEGORY_EDIT, L"Удалить", base::string16(),
                        IDB_DELETE));
