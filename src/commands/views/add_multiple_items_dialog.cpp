...
void AddMultipleItemsDialog::OnInitDialog() {
  ...
  WTL::CUpDownCtrl(GetDlgItem(window_handle(), IDC_COUNT_SPIN)).SetRange(0, 1000);
  WTL::CUpDownCtrl(GetDlgItem(window_handle(), IDC_STARTING_ADDRESS_SPIN)).SetRange(0, 10000);
  WTL::CUpDownCtrl(GetDlgItem(window_handle(), IDC_STARTING_NUMBER_SPIN)).SetRange(0, 10000);
