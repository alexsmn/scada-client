...
| 2.2 | **Active-alarm surface vs. event journal split** (principle §3): unacknowledged/actionable strip separate from full history. | `modules/events/` | 0.2 | Alarm strip shows only actionable items; journal keeps full history; ack-all works. |
