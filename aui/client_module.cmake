...
function(client_module MODULE_NAME)
  ...
  if (NOT ARG_CONFIG)
    set(ARG_CONFIG "${CLIENT_UI_CONFIGS}")
  endif()

  set(ENABLED_CONFIGS)
  foreach(CONFIG IN LISTS ARG_CONFIG)
    if(CONFIG IN_LIST CLIENT_UI_CONFIGS)
      list(APPEND ENABLED_CONFIGS ${CONFIG})
    endif()
  endforeach()

  foreach(CONFIG IN LISTS ENABLED_CONFIGS)
    ...
    if(CONFIG STREQUAL "qt")
      ...
      if(TRANSLATIONS)
        ...
        if(COMMAND qt_create_translation)
          qt_create_translation(TRANSLATIONS_OUT ${SOURCES} ${TRANSLATIONS})
        endif()
...
function(client_module_include_directories MODULE_NAME)
  ...
  foreach(CONFIG IN LISTS CLIENT_UI_CONFIGS)
