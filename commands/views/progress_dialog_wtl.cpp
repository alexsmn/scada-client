...
ProgressDialogWtl::ProgressDialogWtl() : cancelled_(false) {
  Create(NULL);
  ShowWindow(SW_SHOW);
}
...
LRESULT ProgressDialogWtl::OnInitDialog(UINT /*uMsg*/,
                                        WPARAM /*wParam*/,
                                        LPARAM /*lParam*/,
                                        BOOL& /*bHandled*/) {
...
LRESULT ProgressDialogWtl::OnCancel(WORD /*wNotifyCode*/,
                                    WORD wID,
                                    HWND /*hWndCtl*/,
                                    BOOL& /*bHandled*/) {
  cancelled_ = true;
