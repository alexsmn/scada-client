// Created by Microsoft (R) C/C++ Compiler Version 10.00.40219.01 (51fcd360).
//
// c:\work\workplace\trunk\build-vs10\debug\objs\client\sdecore.tlh
//
// C++ source equivalent of Win32 type library C:\Program Files\modus510\bin\sdecore.tlb
...
ISDEPage : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall get_Params (
        /*[out,retval]*/ struct IParams * * Value ) = 0;
...
ISDEDocument : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall get_CurrentEntity (
        /*[out,retval]*/ struct IDispatch * * Value ) = 0;
      virtual HRESULT __stdcall put_CurrentEntity (
        /*[in]*/ struct IDispatch * Value ) = 0;
